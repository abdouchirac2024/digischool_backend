...
public class EleveSeeder {
    ...
    public void seed() {
        ...
        createEleve("ELV-ECB-001", "Nkoulou", "Paul", LocalDate.of(2014, 3, 15),
                "Yaounde", Sexe.M, bastos, ecoleBilingue);
        createEleve("ELV-ECB-002", "Nkoulou", "Marie", LocalDate.of(2016, 7, 22),
                "Yaounde", Sexe.F, bastos, ecoleBilingue);
        createEleve("ELV-ECB-003", "Manga", "Thierry", LocalDate.of(2013, 11, 5),
                "Yaounde", Sexe.M, nlongkak, ecoleBilingue);
        createEleve("ELV-ECB-004", "Manga", "Sarah", LocalDate.of(2015, 1, 18),
                "Yaounde", Sexe.F, nlongkak, ecoleBilingue);
        createEleve("ELV-ECB-005", "Ateba", "Junior", LocalDate.of(2014, 9, 30),
                "Yaounde", Sexe.M, bastos, ecoleBilingue);

        // Eleves Progressive College (Douala)
        createEleve("ELV-ECA-001", "Ebogo", "Samuel", LocalDate.of(2012, 8, 20),
                "Douala", Sexe.M, bonamoussadi, ecoleAnglo);
        createEleve("ELV-ECA-002", "Ebogo", "Grace", LocalDate.of(2014, 4, 12),
                "Douala", Sexe.F, bonamoussadi, ecoleAnglo);
        createEleve("ELV-ECA-003", "Njock", "Kevin", LocalDate.of(2013, 6, 8),
                "Douala", Sexe.M, bonamoussadi, ecoleAnglo);

        // Eleves Groupe Scolaire Les Champions (Bafoussam)
        createEleve("ELV-ECF-001", "Wabo", "Rodrigue", LocalDate.of(2006, 11, 10),
                "Bafoussam", Sexe.M, tamdja, ecoleFranco);
        createEleve("ELV-ECF-002", "Wabo", "Patricia", LocalDate.of(2008, 2, 25),
                "Bafoussam", Sexe.F, tamdja, ecoleFranco);
        createEleve("ELV-ECF-003", "Tchinda", "Boris", LocalDate.of(2007, 5, 14),
                "Bafoussam", Sexe.M, tamdja, ecoleFranco);

 ...
 *
 * Serialisation: ObjectMapper sans type polymorphique pour eviter les erreurs
 * de deserialisation.
 * Le cache est automatiquement nettoye au demarrage pour eviter les donnees
 * corrompues.
 */
@Configuration
@EnableCaching
public class RedisConfig {
    ...
    /**
     * ObjectMapper configure pour la serialisation JSON simple sans metadata de
     * type :
     * - FAIL_ON_UNKNOWN_PROPERTIES=false : champs inconnus ignores (compatibilite
     * apres rebuild)
    ...
    private GenericJackson2JsonRedisSerializer buildSerializer() {
        ...
        // Ne pas activer le typage polymorphique pour eviter les problemes de
        // deserialisation
